class AnimalModuleConstants:
    ...
    """Minimum pen-level DMI for dry cows calculated as an average across the literature, kg/day (Reed 2015; Nennich 2015). 
    """

    MINIMUM_DMI_HEIFER: float = 4.17
    """Minimum pen-level DMI for heifers calculated as an average across the literature, kg/day (Reed 2015; Nennich 2015). 
    """

    MINIMUM_DMI_CALF: float = 2.38
    """Minimum pen-level DMI for calves calculated as an average across the literature, kg/day (Nennich 2015). 
    """

    MINIMUM_DMI_LACT_FOR_MANURE_VS: float = 7.1
    """Minimum DMI for lactating cows in the dataset used to generate the equation, kg/day (Appuhamy 2018). 
    """

    MINIMUM_DMI_DRY_FOR_MANURE_VS: float = 7.1
    """Minimum DMI for dry cows in the dataset used to generate the equation, kg/day (Appuhamy 2018). 
    """
