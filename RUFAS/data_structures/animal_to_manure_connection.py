...
class ManureStream:
    ...
    def split_stream(self, split_ratio: float, stream_type: StreamType | None = None,
                     manure_stream_deposition_split: float | None = None) -> "ManureStream":
        """
        ...
        if self.pen_manure_data is not None and stream_type is not None:
            split_pen_manure_data = PenManureData(
                ...
                manure_deposition_surface_area=self.pen_manure_data.manure_deposition_surface_area
                * manure_stream_deposition_split if manure_stream_deposition_split is not None
