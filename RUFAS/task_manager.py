...
class TaskType(Enum):
    ...
    SIMULATION_MULTI_RUN = ("Runs multiple simulations to generate statistically significant results. "
    ...
    END_TO_END_TESTING = ("Runs RuFaS's end-to-end testing routine. Ensures all components of RuFaS work together "
