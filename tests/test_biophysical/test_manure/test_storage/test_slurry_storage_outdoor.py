    ...
    [
        (
            ...
            ManureStream(
                ...
                potassium=50.55,
                ash=60.66,
                manure_non_degradable_volatile_solids=53.379999999999995,
                manure_degradable_volatile_solids=59.32749999999999,
...
def test_apply_methane_emissions(
    ...
    assert mock_calculate_methane_emissions.call_args_list == [
        call(
            volatile_solids=stored_manure.manure_degradable_volatile_solids,
