...
Two known limitations, both documented in \texttt{field\_curing.py}'s module docstring: day/night respiration periods are approximated using RuFaS's daily maximum/minimum temperature rather than true 12-hour period averages, and quality (crude protein/NDF) concentration is only modeled under leaching, not under respiration alone, since DAFOSYM's respiration-driven quality equation is out of scope for this phase.
