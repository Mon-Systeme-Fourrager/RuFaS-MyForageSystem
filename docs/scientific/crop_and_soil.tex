...
The full field-curing simulation (\texttt{simulate\_field\_curing}) iterates \textbf{[SC.CRP.79]}--\textbf{[SC.CRP.84]} once per day of the wilt window, compounding each day's combined respiration and rain losses multiplicatively against that day's starting dry-matter mass, rather than summing fractions against the original mass:
   \vspace{0.2cm}
