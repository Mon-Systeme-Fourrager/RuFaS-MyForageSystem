...
BWR = 1. # ratio of mature body weight to holstein mature weight of 690 kg
BaseNED = .6 # Baseline net energy density of the diet
HOUSE = "Barn"
...
##########################################
## **************************************         Reduce BMY to get a feasible solution
## **************************************
...
### These are used to calculate 5 metrics (constraints) of the feed for use in ration forumlation
    ...
    #read in feed matrix
    feed = read.csv("feed inputs2 - No HMC.csv")
