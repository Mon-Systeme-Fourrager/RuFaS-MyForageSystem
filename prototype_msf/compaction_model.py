...
if __name__ == "__main__":
    ...
    print()
    print("Quebec B-horizon soil properties are not loaded either.")
    print("RT-08 holds surface texture only. The IRDA PPC dataset has")
    print("clay, silt and organic matter by horizon including B - see")
    print("prototype_msf/irda_soil_database.md.")
