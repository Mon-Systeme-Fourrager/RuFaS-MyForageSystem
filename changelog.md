...
- [TBD](https://github.com/Mon-Systeme-Fourrager/RuFaS-MyForageSystem/pull/TBD) - [minor change] [Tooling] [NoInputChange] [NoOutputChange] Document the new upstream input directories in the layered `CLAUDE.md`: `input/data/crop_configurations/` in the field subsystem doc, and `input/data/animal_genetics/` + `input/data/animal_health/` in the animal subsystem doc.
