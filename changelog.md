...
- [35](https://github.com/Mon-Systeme-Fourrager/RuFaS-MyForageSystem/pull/35) - [minor change] [Animal Module] [NoInputChange] [NoOutputChange] Step 7.6 — add None-guard for `wean_weight` and missing required metric fields (`beef_lactation_day`, `beef_wean_weight_kg`) to `AnimalModuleReporter.report_cow_calf_performance`; add two unit tests covering None-fallback to 0.0 and required field presence.
